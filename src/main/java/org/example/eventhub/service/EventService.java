...
public class EventService {
    ...
    public EventResponseLong createEvent(EventDtoRequest dto) { // TODO возможно проверку на существование
    ...
    public EventResponseLong updateEvent(Long id, EventDtoRequest dto) {
        Event event = repository.findById(id)
                .orElseThrow(() -> new EventNotFoundException("Event с id" + id + " не найдено"));
